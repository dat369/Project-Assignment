            ...
            <tbody>
                <c:forEach items="${OrderList}" var="item" varStatus="loop">
                    <tr>
                        ...
                        <c:if test="${item.orderStatus ne 'Đơn hàng đã giao thành công'}">
                            <td><button class="view-button">Xem Chi Tiết</button></td>
                        </c:if>
                        <c:if test="${item.orderStatus eq 'Đơn hàng đã giao thành công'}">
                            <td>
                                <div class="mb-3">
                                    <span class="form-text">Đơn hàng đã hoàn thành</span>
                                </div>
                            </td>
                        </c:if>
