                    ...
                    <tr class="detail-row" style="margin-bottom: 5vh;">
                        <td class="detail-row" colspan="5">
                            <div class="detail-box" style="display: none;">
                                ...
                                <div class="buttons">
                                    <a href="/ProjectAssignment/deleted?choice=deleted&orderId=${item.orderID}"><button class="btn btn-primary btn-lg btn-dark text-uppercase btn-rounded-none fs-6 confirm-button">Hủy đơn hàng</button></a>
                                </div>
                            </div>
                        </td>
                    </tr>
